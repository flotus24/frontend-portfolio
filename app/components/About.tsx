...
const About = () => {
  return (
    <div
      id="about"
      className="w-full md:pt-16 md:pb-20 bg-slate-900 text-white"
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        >
          ...
          skills. I have worked with bunch of techs like frontend framework
          React and Vue, Backend framework NestJS, to real time library
          Socket.io. I am also a quick learner and confident that I have the
          skills and experience that you are looking for in a Frontend
